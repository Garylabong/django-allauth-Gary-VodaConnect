...
class OrderRequestForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["address"] = forms.CharField(
            required=True,
            label="Complete Address ( Incase of porting)",
        ...
        #         label="",
        #         widget=forms.TextInput(
        #             attrs={"class": "form-control4", "placeholder": "Prepared Area Code"}
        #         ),
        #     )
        ...
        #                 "class": "form-control5",
        #                 "type": "number",
        #                 "placeholder": "Total Number Of Phone Lines Needed",
        #             }
        #         ),
        #     )
        ...
        #     )
        # self.fields["notes"] = forms.TextInput(
        #     required=True,
        #     label="Notes",
        #     widget=forms.TextInput(
        #         attrs={
